...
function operationView(){
  ...
  return `<div class="ws-title-row"><div><div class="ws-kicker">Conclusion</div><div class="ws-title">经营结论</div></div><span class="status-chip warn">持续观察</span></div><div class="gate-card"><div class="gate-top"><span class="gate-badge" style="background:var(--warning)">持有观察</span><strong>先压渠道依赖，再验证价格和成本改善</strong></div><p>经营改善有效后再回到投资模型复核项目价值。</p></div><div class="action-plan"><div class="action-box"><div class="action-day">30</div><strong>渠道</strong><p>建立直销与协议客验证。</p></div><div class="action-box"><div class="action-day">60</div><strong>价格</strong><p>验证 ADR 提升空间。</p></div><div class="action-box"><div class="action-day">90</div><strong>复盘</strong><p>实际值回填并重跑模型。</p></div></div>`;
}
